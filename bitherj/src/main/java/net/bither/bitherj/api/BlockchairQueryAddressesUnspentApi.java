...
public class BlockchairQueryAddressesUnspentApi extends RerequestHttpGetResponse {
    ...
    public static JSONObject queryAddressesUnspent(String addresses) throws Exception {
        BlockchairQueryAddressesUnspentApi blockchairQueryAddressUnspentApi = new BlockchairQueryAddressesUnspentApi();
