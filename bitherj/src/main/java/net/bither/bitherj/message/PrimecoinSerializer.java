...
import static net.bither.bitherj.utils.Utils.readUint32;
import static net.bither.bitherj.utils.Utils.uint32ToByteArrayBE;
...
public class PrimecoinSerializer {
    ...
    public void serialize(String name, byte[] message, OutputStream out) throws IOException {
        ...
        Utils.uint32ToByteArrayBE(PrimerjSettings.getPacketMagic(), header, 0);
    ...
    public void seekPastMagicBytes(ByteBuffer in) throws BufferUnderflowException {
        ...
        while (true) {
            ...
            byte expectedByte = (byte) (0xFF & PrimerjSettings.getPacketMagic() >>> (magicCursor * 8));
            if (b == expectedByte) {
                magicCursor--;
                if (magicCursor < 0) {
