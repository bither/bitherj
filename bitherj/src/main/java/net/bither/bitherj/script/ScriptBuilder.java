...
public class ScriptBuilder {
    ...
    public static Script createOutputScript(String to) {
        try {
            if (Utils.getAddressHeader(to) == BitherjSettings.p2shHeader || Utils.getAddressHeader(to) == BitherjSettings.btgP2shHeader || Utils.getAddressHeader(to) == BitherjSettings.btwP2shHeader) {
                ...
                return new ScriptBuilder()
                        ...
                        .op(OP_EQUAL)
                        .build();
            } else if (Utils.getAddressHeader(to) == BitherjSettings.addressHeader || Utils.getAddressHeader(to) == BitherjSettings.btgAddressHeader || Utils.getAddressHeader(to) == BitherjSettings.btwAddressHeader){
