...
public class LoadOldAddress {

    //todo remove isXRandom and isCompress from salt
    public static List<Address> initPrivateKeyListByDesc() {
    ...
    public static List<Address> initWatchOnlyListByDesc() {
    ...
    public static List<Address> initTrashListByDesc() {
