...
import org.primer.primerj.api.http.HttpPostResponse;
...
public class PrimerErrorApi extends HttpPostResponse<String> {

    private static String ERROR_MSG = "error_msg";
    private String mErrorMsg;

    public PrimerErrorApi(String errorMsg) {
        this.mErrorMsg = errorMsg;
        setUrl(PrimerUrl.BITHER_ERROR_API);
    }
