...
import org.primer.primerj.api.CreateHDMAddressApi;
...
public class HDMKeychain extends AbstractHD {
    ...
    public HDMKeychain(EncryptedData encryptedMnemonicSeed, CharSequence password,
            ...
            HDMPrimerIdNotMatchException, MnemonicException.MnemonicLengthException {
            ...
            if (pubs.size() > 0) {
                try {
                    ...
                    if (!Arrays.equals(pubDerived, pubFetched)) {
                        wipeMnemonicSeed();
                        wipeHDSeed();
                        throw new HDMPrimerIdNotMatchException();
                    }
    ...
    public static final class HDMPrimerIdNotMatchException extends RuntimeException {
        public static final String msg = "HDM Bid Not Match";

        public HDMPrimerIdNotMatchException() {
            super(msg);
        }
    }
