...
import org.primer.primerj.message.AlertMessage;
import org.primer.primerj.message.BlockMessage;
import org.primer.primerj.message.FilteredBlockMessage;
import org.primer.primerj.message.GetAddrMessage;
import org.primer.primerj.message.GetBlocksMessage;
import org.primer.primerj.message.GetDataMessage;
import org.primer.primerj.message.GetHeadersMessage;
import org.primer.primerj.message.HeadersMessage;
import org.primer.primerj.message.InventoryMessage;
import org.primer.primerj.message.MemoryPoolMessage;
import org.primer.primerj.message.Message;
import org.primer.primerj.message.NotFoundMessage;
import org.primer.primerj.message.PingMessage;
import org.primer.primerj.message.PongMessage;
import org.primer.primerj.message.RejectMessage;
import org.primer.primerj.message.VersionAck;
import org.primer.primerj.message.VersionMessage;
import org.primer.primerj.net.NioClientManager;
import org.primer.primerj.net.PeerSocketHandler;
import org.primer.primerj.script.Script;
import org.primer.primerj.utils.InventoryItem;
...
public class Peer extends PeerSocketHandler {
    ...
    public Peer(InetAddress address) {
        super(new InetSocketAddress(address, PrimerjSettings.port));
        this.peerAddress = address;
        peerPort = PrimerjSettings.port;
