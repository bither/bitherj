...
import org.primer.primerj.exception.ProtocolException;
import org.primer.primerj.exception.ScriptException;
import org.primer.primerj.exception.VerificationException;
import org.primer.primerj.message.BlockMessage;
import org.primer.primerj.message.Message;
import org.primer.primerj.script.Script;
import org.primer.primerj.script.ScriptBuilder;
import org.primer.primerj.script.ScriptOpCodes;
import org.primer.primerj.utils.PrivateKeyUtil;
import org.primer.primerj.utils.Sha256Hash;
import org.primer.primerj.utils.UnsafeByteArrayOutputStream;
import org.primer.primerj.utils.Utils;
import org.primer.primerj.utils.VarInt;
...
import static org.primer.primerj.utils.Utils.doubleDigest;
import static org.primer.primerj.utils.Utils.uint32ToByteStreamLE;
import static org.primer.primerj.utils.Utils.uint64ToByteStreamLE;
...
//    public int length;
     ...
     *
     * @throws org.primer.primerj.exception.ScriptException if the scriptPubKey is not a pay to address or pay to pubkey script.
     */
    ...
    /**
     * Same as {@link #addSignedInput(org.primer.primerj.core.Out, org.primer.primerj.script.Script, org.primer.primerj.crypto.ECKey, org.primer.primerj.crypto.TransactionSignature.SigHash, boolean)}
     * but defaults to {@link org.primer.primerj.crypto.TransactionSignature.SigHash#ALL} and
...
//            cannot be statically proven
     ...
     * a wrapper around calling {@link org.primer.primerj.core.Tx#hashForSignature(int, byte[],
     * org.primer.primerj.crypto.TransactionSignature.SigHash, boolean)}
     * followed by {@link org.primer.primerj.crypto.ECKey#sign(byte[], org.spongycastle.crypto.params.KeyParameter)} and
     * then returning
     * a new {@link org.primer.primerj.crypto.TransactionSignature}.
     *
     ...
     * a wrapper around calling {@link org.primer.primerj.core.Tx#hashForSignature(int, byte[],
     * org.primer.primerj.crypto.TransactionSignature.SigHash, boolean)}
     * followed by {@link org.primer.primerj.crypto.ECKey#sign(byte[])} and then returning a new {@link org.primer.primerj.crypto.TransactionSignature}.
     *
     * @param inputIndex            Which input to calculate the signature for, as an index.
     * @param key                   The private key used to calculate the signature.
     ...
     * spent.
     *
     * @throws org.primer.primerj.exception.VerificationException
     */
     ...
     * see {@link org.primer.primerj.core.Tx#isFinal(int, long)}
     * </p>
     */
