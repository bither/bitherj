...
package org.primer.primerj.crypto;
...
public class ECKey implements Serializable {
    ...
    /**
     * A constructor variant with BigInteger pubkey. See {@link org.primer.primerj.crypto.ECKey#ECKey(java.math.BigInteger, byte[])}.
     */
...
//    }
     ...
     * usually encoded using DER format, so you want {@link org.primer.primerj.crypto.ECKey.ECDSASignature#toASN1()}
     * instead. However sometimes the independent components can be useful, for instance, if you're doing to do
     * further EC maths on them.
     *
     * @throws org.primer.primerj.crypto.KeyCrypterException if this ECKey doesn't have a private part.
     */
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Bitcoin protocol, they are
     * usually encoded using DER format, so you want {@link org.primer.primerj.crypto.ECKey.ECDSASignature#encodeToDER()}
...
//        signature.ensureCanonical();
     ...
     * @throws org.primer.primerj.crypto.KeyCrypterException if this ECKey is encrypted and no AESKey is provided or it does not decrypt the ECKey.
     */
...
//            throw new IllegalStateException("This ECKey does not have the private key necessary for signing.");
    ...
    /**
     * Convenience wrapper around {@link org.primer.primerj.crypto.ECKey#signedMessageToKey(String, String)}. If the key derived from the
