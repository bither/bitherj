...
package org.primer.primerj.db.imp;
...
import org.primer.primerj.core.OutPoint;
...
import org.primer.primerj.db.imp.base.ICursor;
...
import static org.primer.primerj.db.imp.AbstractTxProvider.applyCursorOut;
...
public abstract class AbstractHDAccountAddressProvider extends AbstractProvider implements IHDAccountAddressProvider {
    ...
    public List<Tx> getTxAndDetailByHDAccount(int hdAccountId, int page) {
        ...
        this.execQueryLoop(db, sql, new String[]{
                Integer.toString(hdAccountId)
                , Integer.toString((page - 1) * PrimerjSettings.TX_PAGE_SIZE)
                , Integer.toString(PrimerjSettings.TX_PAGE_SIZE)
