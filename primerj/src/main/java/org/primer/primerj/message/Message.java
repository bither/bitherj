...
//    }
    ...
    protected Message(byte[] msg, int offset) throws ProtocolException {
        this(msg, offset, PrimerjSettings.PROTOCOL_VERSION, UNKNOWN_LENGTH);
    }

    protected Message(byte[] msg, int offset, int length) throws ProtocolException {
        this(msg, offset, PrimerjSettings.PROTOCOL_VERSION, length);
    }
    ...
    /**
     * Should only used by PrimecoinSerializer for cached checksum
     *
     * @return the checksum
     */
    ...
    /**
     * Should only used by PrimecoinSerializer for caching checksum
     *
