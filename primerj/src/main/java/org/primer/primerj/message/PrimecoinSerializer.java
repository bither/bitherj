...
package org.primer.primerj.message;


import org.primer.primerj.PrimerjSettings;
import org.primer.primerj.core.BloomFilter;
...
import static org.primer.primerj.utils.Utils.bytesToHexString;
import static org.primer.primerj.utils.Utils.doubleDigest;
import static org.primer.primerj.utils.Utils.readUint32;
import static org.primer.primerj.utils.Utils.uint32ToByteArrayBE;
 ...
 * </ul>
 */
public class PrimecoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(PrimecoinSerializer.class);
    ...
    /**
     * Constructs a PrimecoinSerializer with the given behavior.
     * <p/>
     * //     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public PrimecoinSerializer() {
    ...
    public void serialize(String name, byte[] message, OutputStream out) throws IOException {
        ...
        uint32ToByteArrayBE(PrimerjSettings.packetMagic, header, 0);
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("PrimecoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        ...
        PrimecoinPacketHeader header = new PrimecoinPacketHeader(in);
     ...
     */
    public PrimecoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new PrimecoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link PrimecoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(PrimecoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public void seekPastMagicBytes(ByteBuffer in) throws BufferUnderflowException {
        ...
        while (true) {
            ...
            byte expectedByte = (byte) (0xFF & PrimerjSettings.packetMagic >>> (magicCursor * 8));
            if (b == expectedByte) {
                magicCursor--;
                if (magicCursor < 0) {
    ...
    public static class PrimecoinPacketHeader {
        /**
        ...
        public PrimecoinPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
