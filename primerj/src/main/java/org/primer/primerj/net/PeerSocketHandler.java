...
package org.primer.primerj.net;


import com.google.common.annotations.VisibleForTesting;

import org.primer.primerj.exception.ProtocolException;
import org.primer.primerj.message.PrimecoinSerializer;
import org.primer.primerj.message.Message;
import org.primer.primerj.message.PeerAddress;
import org.primer.primerj.utils.Threading;
 ...
 * {@link org.primer.primerj.net} classes and {@link org.primer.primerj.core.Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
    private static final Logger log = LoggerFactory.getLogger(PeerSocketHandler.class);

    private final PrimecoinSerializer serializer;
    ...
    public int receiveBytes(ByteBuffer buff) {
        checkArgument(buff.position() == 0 && buff.capacity() >= PrimecoinSerializer.PrimecoinPacketHeader.HEADER_LENGTH + 4);
        try {
     ...
     * called automatically by {@link org.primer.primerj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
