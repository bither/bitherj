...
public class ScriptTest extends ApplicationTest {
...
//    }
    ...
    public void testDataDrivenValidScripts() throws Exception {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                getContext().getResources().openRawResource(R.raw.script_valid), Charset.forName("UTF-8")));
...
//        NetworkParameters params = TestNet3Params.get();
    ...
    public void testDataDrivenInvalidScripts() throws Exception {
        ...
        BufferedReader in = new BufferedReader(new InputStreamReader(
                this.getContext().getResources().openRawResource(R.raw.script_invalid)
...
//        NetworkParameters params = TestNet3Params.get();
    ...
    public void testDataDrivenValidTransactions() throws Exception {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                getContext().getResources().openRawResource(R.raw.tx_valid), Charset.forName("UTF-8")));
...
//        NetworkParameters params = TestNet3Params.TestNet3Params();
    ...
    public void testDataDrivenInvalidTransactions() throws Exception {
        BufferedReader in = new BufferedReader(new InputStreamReader(
                getContext().getResources().openRawResource(R.raw.tx_invalid), Charset.forName("UTF-8")));
